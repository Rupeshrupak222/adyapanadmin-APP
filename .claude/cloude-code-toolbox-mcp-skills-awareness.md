...
_Generated: 2026-06-22T11:37:38.436Z_
...
Workspace `mcp.json` _(folder: adyapan_admin-master)_

- **e:\adyapan_admin-master\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\rrupa\.claude.json** — _File exists — no servers defined_
